...
class ExtractionQualityRunner:
    ...
    def _evaluate_tier(
        ...
        """
        # Extract via Marker. Note: rotation artifacts in synthetic images
        # can trigger surya encoder segfaults (see TIER_CONFIGS comment).
        # With rotation disabled, in-process extraction is reliable.
        try:
